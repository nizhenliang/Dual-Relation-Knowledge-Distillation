...
# def build_teacher():
#     teacher_cfg = Config.fromfile("configs/retinanet/retinanet_x101_64x4d_fpn_1x_coco.py")
...
#                     "checkpoints/retinanet_x101_64x4d_fpn_1x_coco_20200130-366f5af.pth",
#                     map_location='cpu')
#     return teacher

# def build_teacher():
#     teacher_cfg = Config.fromfile("configs/faster_rcnn/faster_rcnn_x101_64x4d_fpn_1x_coco.py")
#     teacher = build_detector(
#         teacher_cfg.model, train_cfg=teacher_cfg.train_cfg, test_cfg=teacher_cfg.test_cfg)
#     load_checkpoint(teacher,
#                     "checkpoints/faster_rcnn_x101_64x4d_fpn_1x_coco_20200204-833ee192.pth",
#                     map_location='cpu')
#     return teacher
